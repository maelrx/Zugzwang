...
opponent, reasoning effort, output ceiling, retry policy and absence of a
call/ply cap. They vary one search or memory factor at a time around the
episodic four-root baseline. The persistent mode remains scoped to one
episode.
