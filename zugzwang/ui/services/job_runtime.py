...
from zugzwang.ui.services.paths import project_root, ui_jobs_root
from zugzwang.ui.services.process_utils import is_pid_running, python_executable, tail_text, terminate_pid
from zugzwang.ui.state.job_store import DEFAULT_JOBS_PATH, create_job, get_job, list_jobs, update_job
from zugzwang.ui.types import CancelResult, JobHandle, JobStatus, JobType
...
def start_job(
    *,
    ...
    wrapper_cmd = [
        python_executable(),
        "-m",
        "zugzwang.ui.services.job_worker",
        "--stdout-path",
        str(stdout_path),
        "--stderr-path",
        str(stderr_path),
